...
Name:		python34-pytesseract
Version:	0.1.7
Release:	1%{?dist}
Summary:    pytesseract for python
...
%files
%{_bindir}/pytesseract
%{pythondir}/pytesseract
%{pythondir}/pytesseract-%{version}-py%{pythonver}.egg-info

%changelog
* Tue Oct 31 2017 Andreas Muehlemann <andreas.muehlemann@switch.ch> - 0.1.7
- first version
