...
%endif
    ...
    posix shmop sysvshm sysvsem sysvmsg xml; do
...
# Remove pear files
rm -rf $RPM_BUILD_ROOT%{_bindir}/pear \
       $RPM_BUILD_ROOT%{_bindir}/peardev \
       $RPM_BUILD_ROOT%{_bindir}/pecl \
       $RPM_BUILD_ROOT%{_etcdir}/pear.conf
...
%changelog
* Mon Jul 16 2018 Andreas Muehlemann <andreas.muehlemann@switch.ch> - 7.0.30
- update to php-7.0.30

* Fri Aug 18 2017 Andreas Muehlemann <andreas.muehlemann@switch.ch> - 7.0.22
- update to php-7.0.22
